...
| Uberspace host | A host on [Uberspace](https://uberspace.de) where `biking2.jar` runs inside a [Server JRE](https://www.oracle.com/technetwork/java/javase/downloads/server-jre8-downloads-2133154.html) with restricted memory usage. |
